...
class CustomInstaller:
    def __init__(self, venv_dir="venv", requirements_file="requirements.txt", batch_file_name="infotext_run.bat", script_name="infotext.py", commands=None):
    ...
    def install_requirements(self):
        ...
        try:
            ...
            if os.path.exists(self.requirements_file):
                ...
                subprocess.run([self.python_executable, "-m", "pip", "install", "-r", self.requirements_file], check=True)
                print("Default requirements installed.")
...
if __name__ == "__main__":
    commands = [
        ...
        "venv\\Scripts\\python.exe infotext.py"  
    ]


    # Initialize the BatchFileCreator 
    setup = CustomInstaller(commands=commands)
